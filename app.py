...
with col0:
    filtro_fuente = st.multiselect(
        "🌐 Fuente",
        ["Licitaciones Generales PLACSP", "Licitaciones Agregadas PLACSP", "TED", "PSCP Catalunya", "Euskadi", "Comunidad de Madrid", "Contratación Navarra", "Gobierno de La Rioja", "Galicia"],
        default=[],
        key="filtro_fuente",
    )
with col_tipo:
